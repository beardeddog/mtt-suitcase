...
# setup and layout all the command line arguments
...
# check for various environment setting and take appropriate action
...
def main():
  ...
  args = setupCmdLineArgs().parse_args()

  (topdir, basedir) = checkEnvironment(args)
